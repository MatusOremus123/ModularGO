...
class ProductPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final List<Map<String, String>> products = [
      ...
      {'image': 'assets/PenPicture.png', 'name': 'Marker', 'price': '€2.75'},
      {'image': 'assets/NotebookNew.png', 'name': 'Notebook', 'price': '€9.50'},
      ...
      {'image': 'assets/CuttinMat.png', 'name': 'Cutting Mat', 'price': '€12.00'},
